...
struct Typography
{
    ...
    static const touchgfx::FontId FOR_TITLES = 3;
};

struct TypographyFontIndex
{
    static const touchgfx::FontId DEFAULT = 0;    // arial_24_4bpp
    static const touchgfx::FontId LARGE = 1;      // verdana_40_4bpp
    static const touchgfx::FontId SMALL = 2;      // verdana_15_4bpp
    static const touchgfx::FontId FOR_TITLES = 3; // verdanab_15_4bpp
